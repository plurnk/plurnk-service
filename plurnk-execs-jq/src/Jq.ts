...
// So `### EXEC_ [jq] (data.json)` filters a file with its body, while a targetless
// `### EXEC_ [jq]` runs its body against null input. A tag-addressed prior stream can be the target
