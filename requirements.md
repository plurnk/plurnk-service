...
YOU MUST terminate the turn with either a loop continuing (102), loop terminating (200), loop waiting (202), or loop failed (500) user message or brief status update `<<SEND[{102|200|202|500}]:...:SEND`
