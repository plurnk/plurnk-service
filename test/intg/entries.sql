...
SELECT id, version, scope, session_id, scheme, pathname, attributes FROM entries LIMIT 1;
...
-- EXEC: test_entries_insert_session_no_session_id
INSERT INTO entries (scope, pathname) VALUES ('session', '/x');
