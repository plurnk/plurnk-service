...
export default class PlurnkErrorStrategy extends DefaultErrorStrategy {
    ...
    static #LEXER_MODE_CONTEXT: Record<string, string> = {
        ...
        METADATA: "in `[metadata]` modifier - expected single-line JSON option objects or `]`",
        BODY: "in body",
    };
