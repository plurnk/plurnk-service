...
test("[§agui-daemon-client][§agui-run-endpoint][§agui-thread-is-run] in-process module: boot plug-point → AG-UI+ run → real model → SSE", { skip: gated, timeout: 180_000 }, async () => {
