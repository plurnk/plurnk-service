        ...
        try {
            ...
            switch (kind) {
                ...
                case "op.parse": {
                    ...
                    const parsed = PlurnkParser.parseClient(p.text, { executors: this.#seam().executorTags(world.workspaceId), jsonBodyExecutors: this.#seam().executorJsonBodyTags(world.workspaceId) });
