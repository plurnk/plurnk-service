...
test("log/entry (model SEND) → assistant TEXT_MESSAGE triple", () => {
    const evs = router().route("log/entry", { entry: { id: 1, worker_id: 10, loop_id: 2, origin: "model", op: "SEND", status_rx: 200, coordinate: "1.2.3", tx: { body: "hello" }, rx: { recipients: ["agui://anonymous/threads/t/messages/m"] }, turn_id: 1 } });
