...
const readStmt = (target: UrlPath): ReadStatement => ({ op: "READ", suffix: "READ", annotation: null, signal: null, target, lineMarker: null, body: null, position: { line: 0, column: 0 } });
const editStmt = (
    target: UrlPath,
    body: string | null,
    lineMarker: ResolvedEditStatement["lineMarker"] = null,
): ResolvedEditStatement => ({ op: "EDIT", suffix: "EDIT", annotation: null, signal: null, target, lineMarker, body, position: { line: 0, column: 0 } });
...
const sendStmt = (signal: number, target: UrlPath, body?: string): SendStatement => ({ op: "SEND", suffix: "SEND", annotation: null, signal, target, lineMarker: null, body: body === undefined ? null : { raw: body, json: null }, position: { line: 0, column: 0 } });
const killStmt = (target: UrlPath): KillStatement => ({ op: "KILL", suffix: "KILL", annotation: null, signal: null, target, lineMarker: null, body: null, position: { line: 0, column: 0 } });
