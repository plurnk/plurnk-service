...
| Operation                                      | Behavior                                                                                  |
| ---------------------------------------------- | ----------------------------------------------------------------------------------------- |
| `## READ1 (http(s)://…)`                       | Fetch or reuse/revalidate a GET representation, then stream the selected response channel |
| `## READ1 (http(s)://…) <scope>`               | Apply the standard entry READ to an already-materialized response without refetching      |
| `## FIND1 (http(s)://…)` with matcher body     | Materialize an exact URL when required, then use the universal entry query and matcher    |
| `## SEND1 [200] (http(s)://…)` with body       | POST the body and stream the response                                                     |
| `## EDIT1 (http(s)://…)` with body             | PUT a whole-resource replacement; line-scoped HTTP edits are invalid                      |
| `## KILL1 (http(s)://…)`                       | DELETE the remote resource and stream the response                                        |
| `## SEND1 [499] (http(s)://…)`                 | Cancel the routed in-flight subscription                                                  |
| `## SEND1 [410] (http(s)://…)`                 | Delete the local stored response entry                                                    |
