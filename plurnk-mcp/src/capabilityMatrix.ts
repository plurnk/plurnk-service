...
export const CAPABILITY_MATRIX: readonly CapabilityRow[] = [
    ...
    },
    {
        ...
        disposition: "deferred",
        composed: false,
        evidence: ["https://repo.possumtech.com/plurnk/plurnk-service/issues/271"],
        note: "Deferred to #271; the daemon is not a second application platform, and no client can claim the required sandbox today.",
    },
    {
        id: "extension-skills",
