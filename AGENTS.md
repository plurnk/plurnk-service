...
_(inbox drained 2026-06-18 — done notes cleared: sqlite-perf/size → sqlrite#7 + `PLURNK_SQLITE_*` knobs; doc-links → `plurnk:///docs/<tag>.md`; "Plurnk System Tools" naming → already shipped. Design/feature notes moved to § Deferred / design: SEND[300], run:// authority, tools placement, prompt-preview knob, out-of-space story.)_
