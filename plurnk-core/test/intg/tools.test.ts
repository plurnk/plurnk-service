...
test("registered executable tools render as a closed, titled catalogue; omitted when empty", () => {
    ...
    assert.doesNotMatch(noTools, /^## EXEC/m, "no tools content rendered when nothing is enabled");
