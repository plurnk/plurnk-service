...
const seed = async (db: Awaited<ReturnType<typeof openMigrated>>, opts: { fail?: boolean } = {}) => {
    ...
    engine.setExecutors(new ExecutorRegistry(new Map([["search", {
        executor: stubExecutor(opts) as never, namespaceOwner: { kind: "module", name: "search-gate fixture" }, glyph: "🔎", invocation: { body: { role: "search query", required: true } }, documentation: "", available: true, detail: undefined,
    }]])));
