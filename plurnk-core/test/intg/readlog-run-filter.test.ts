// #376 — the seam's readLog honors its workerId filter: two runs, one row each, each read returns
...
test("seam readLog honors the workerId filter — per-run isolation of the journal read (#376)", async () => {
