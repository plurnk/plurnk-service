...
const editStmt = (target: UrlPath, body: string): ResolvedEditStatement => ({
    op: "EDIT", annotation: null, suffix: "", signal: null, target, lineMarker: null, body, position: { line: 1, column: 1 },
});
...
test("a model turn joins an in-flight startup warm before calling its provider", async () => {
    ...
    try {
        ...
        const response: MockResponse = {
            assistant: {
                content: "",
                ops: [{ op: "SEND", annotation: null, suffix: "", signal: 200, target: null, lineMarker: null, body: { raw: "ready", json: null }, position: { line: 1, column: 1 } }],
                reasoning: null,
            },
        };
