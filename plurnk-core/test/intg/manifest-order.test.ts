...
const editStmt = (target: UrlPath, body: string, marker: LineMarker | null = null): ResolvedEditStatement => ({ metadata: null, op: "EDIT", aside: null, target, lineMarker: marker, body, position: { line: 1, column: 1 } });
