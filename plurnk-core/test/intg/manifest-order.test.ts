...
const editStmt = (target: UrlPath, body: string, marker: LineMarker | null = null): ResolvedEditStatement => ({ op: "EDIT", annotation: null, suffix: "", signal: null, target, lineMarker: marker, body, position: { line: 1, column: 1 } });
