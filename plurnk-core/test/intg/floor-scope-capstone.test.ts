...
test("Floor-scope capstone: full DSL surface exercised end-to-end", async () => {
    ...
    try {
        const [editQuestion] = parse("### EDIT_ (worker:///france/capital)\nwhat is the capital of france?");
        ...
        const [editQuestionAgain] = parse("### EDIT_ (worker:///france/capital) <1,-1>\nrephrased question");
        ...
        const [copyOp] = parse("### COPY_ (worker:///france/capital) (fixture:///france/capital)");
        ...
        const [editSkill] = parse("### EDIT_ (fixture:///france/capital) <1,-1>\nParis");
        ...
        const [classifiedFind] = parse("### FIND_ (fixture:///)");
        ...
        const [findByGlob] = parse("### FIND_ (fixture:///)\nParis*");
        ...
        const [moveOp] = parse("### MOVE_ (worker:///france/capital) (worker:///archive/france/capital)");
        ...
        const [deleteOp] = parse("### KILL_ (fixture:///france/capital)");
        ...
        const [sendTerminal] = parse("### SEND_ (TERM)\nanswer delivered");
