...
test("Floor-scope capstone: full DSL surface exercised end-to-end", async () => {
    ...
    try {
        const [editQuestion] = parse("## EDIT1 [geography,question] (worker:///france/capital)\nwhat is the capital of france?");
        ...
        const [editQuestionAgain] = parse("## EDIT1 [geography] (worker:///france/capital) <1,-1>\nrephrased question");
        ...
        const [copyOp] = parse("## COPY1 [answer,france] (worker:///france/capital)\nskill:///france/capital");
        ...
        const [editSkill] = parse("## EDIT1 (skill:///france/capital) <1,-1>\nParis");
        ...
        const [findByTag] = parse("## FIND1 [answer] (skill:///)");
        ...
        const [findByGlob] = parse("## FIND1 (skill:///)\nParis*");
        ...
        const [moveOp] = parse("## MOVE1 (worker:///france/capital)\nworker:///archive/france/capital");
        ...
        const [deleteOp] = parse("## SEND1 [410] (skill:///france/capital)");
        ...
        const [sendTerminal] = parse("## SEND1 [200]\nanswer delivered");
