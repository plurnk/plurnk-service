...
const editStmt = (target: UrlPath, body: string): ResolvedEditStatement => ({ op: "EDIT", annotation: null, suffix: "", signal: null, target, lineMarker: null, body, position: { line: 1, column: 1 } });
const readStmt = (target: UrlPath): ReadStatement => ({ op: "READ", annotation: null, suffix: "", signal: null, target, lineMarker: null, body: null, position: { line: 1, column: 1 } });
