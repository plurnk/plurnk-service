...
const editStmt = (target: UrlPath, body: string): ResolvedEditStatement => ({ metadata: null, op: "EDIT", annotation: null, target, lineMarker: null, body, position: { line: 1, column: 1 } });
const readStmt = (target: UrlPath): ReadStatement => ({ metadata: null, op: "READ", annotation: null, target, lineMarker: null, body: null, position: { line: 1, column: 1 } });
