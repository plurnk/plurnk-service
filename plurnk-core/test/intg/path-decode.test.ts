...
const editStmt = (target: UrlPath, body: string): ResolvedEditStatement => ({ metadata: null, op: "EDIT", aside: null, target, lineMarker: null, body, matcher: null, position: { line: 1, column: 1 } });
const readStmt = (target: UrlPath): ReadStatement => ({ metadata: null, op: "READ", aside: null, target, lineMarker: null, matcher: null, body: null, position: { line: 1, column: 1 } });
