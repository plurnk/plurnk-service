...
// output admission withholds its body; patterns and scoped READs can recover
// the fact from the original source or log receipt.
//
...
// first, output admission withholds that read body and the model recovers with a
