...
export default class Engine {
    ...
    async runTurn({
        ...
        try {
            ...
            // #391 — the turn COORDINATE (session + loop-seq/turn-seq of the turn being generated)
            // rides as first-party metadata (Plurnk-Session-Id/Loop/Turn) so the endpoint flywheel keys
