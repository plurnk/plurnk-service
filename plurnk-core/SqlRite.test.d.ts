...
export class SqlRiteSync {
	...
	test_align_cols_workspaces: SqlRiteSyncPreparedStatements;
	test_align_cols_workers: SqlRiteSyncPreparedStatements;
	...
	test_workspaces_insert_with_sra: SqlRiteSyncPreparedStatements;
	test_workspaces_get_sra: SqlRiteSyncPreparedStatements;
...
export default class SqlRite {
	...
	test_align_cols_workspaces: SqlRitePreparedStatements;
	test_align_cols_workers: SqlRitePreparedStatements;
	...
	test_workspaces_insert_with_sra: SqlRitePreparedStatements;
	test_workspaces_get_sra: SqlRitePreparedStatements;
