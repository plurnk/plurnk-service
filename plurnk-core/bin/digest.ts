...
// the development CLI (npm run dev:digest). Default DB = the SERVICE's DB
// (PLURNK_SERVICE_DB_PATH or its XDG data default), NOT the repo-local DB; exit-1 on a missing DB.
//
