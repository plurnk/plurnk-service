...
| `PLURNK_PROVIDERS_FETCH_TIMEOUT`                            | `600000` | Service-wide ms ceiling on any outbound request (providers and HTTP schemes). Module-specific overrides are allowed below the ceiling. |
