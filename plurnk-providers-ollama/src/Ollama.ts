...
export default class Ollama {
    static async fromEnv(env: NodeJS.ProcessEnv, model: string, options?: ProviderOptions): Promise<Provider> {
        ...
        return new OpenAICompatProvider({
            ...
            fetchTimeoutMs,
            contextSize,
            grammarTemperature: parseRequiredFloat(env.PLURNK_PROVIDERS_GRAMMAR_TEMPERATURE, "PLURNK_PROVIDERS_GRAMMAR_TEMPERATURE", "ollama", 0),
            grammarRepeatPenalty: parseRequiredFloat(env.PLURNK_PROVIDERS_GRAMMAR_REPEAT_PENALTY, "PLURNK_PROVIDERS_GRAMMAR_REPEAT_PENALTY", "ollama", 0),
