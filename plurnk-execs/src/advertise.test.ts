...
test("§3.4 contribute: any surviving runtime suppresses the notice — the sheet lists, it does not apologize", () => {
...
test("§3.4 contribute: one contributor, both cases — permitted and notice are mutually exclusive by construction", () => {
...
test("§3.4 contribute: cause-agnostic — the same empty result whether policy or a host bar zeroed the set", () => {
...
test("§3.4 contribute: the filter is the registry tag — a predicate keyed on runtime drives exactly which survive", () => {
